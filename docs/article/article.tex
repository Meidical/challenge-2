...
\begin{itemize}
    \item A prediction sytem with a api that exposes endpoints for predicting survival classification, survival time regression and relapse with BentoML. The prediction models with the best scores were trainned and imported from MLflow.
